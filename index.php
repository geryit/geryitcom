...
<head>
    ...
    <!-- End Google Tag Manager (noscript) -->
		...
		<footer id="footer">
			<div id="footerWrapper" class="container_12">
				<section class="grid_8">
					...
					&amp; <a href="http://jigsaw.w3.org/css-validator/validator?uri=http://www.geryit.com<?=$_SERVER["REQUEST_URI"];?>&amp;profile=css3&amp;usermedium=all&amp;warning=1&amp;lang=en">CSS 3</a>
        ...
        <link rel="stylesheet" href="//d2g83xhm015jzr.cloudfront.net/dist/styles.min.css.gzip?v=9369"  media="none" onload="if(media!='all')media='all'"/>
        <script async src="//d2g83xhm015jzr.cloudfront.net/dist/scripts.min.js.gzip?v=9369"></script>
	</body>
</html>
